  ...
  return (
    <div className="cart-container p2p-cart-info">
      ...
      <p className="p2p-cart-lead">
        ...
        <strong>gửi yêu cầu mua</strong>, trao đổi trong chat, gặp mặt, rồi dùng <strong>mã OTP</strong> để hoàn tất.
      </p>
      <ul className="p2p-cart-steps">
        <li>Duyệt tài liệu / sách trên trang chủ hoặc mục Duyệt.</li>
        <li>Vào chi tiết sản phẩm và nhấn gửi yêu cầu (hoặc từ danh sách yêu thích, chọn Xem chi tiết).</li>
