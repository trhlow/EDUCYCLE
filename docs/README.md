...
| [architecture/](architecture/README.md) | Topology, auth, WebSocket — trỏ về `ARCHITECTURE.md` ở root |
| [guides/](guides/ai-chatbot.md) | Hướng dẫn theo tính năng (AI chatbot, …) |
