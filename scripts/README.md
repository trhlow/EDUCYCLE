...
| [continuous-dev.sh](continuous-dev.sh) | Bash | Bump semantic version + tag (dùng bởi [continuous-dev.yml](../.github/workflows/continuous-dev.yml) khi bật) |
| [release.sh](release.sh) | Bash | Merge `dev` → `main` + tag (workflow_dispatch trong continuous-dev) |
